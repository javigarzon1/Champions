export const teams = [
  // Bombo 1 - Los 10 mejores equipos según el ranking de la UEFA al inicio de la temporada
...
export const teams = [
  ...
  { id: "atletico", name: "Atlético Madrid", shortName: "ATM", country: "ESP", city: "Madrid", pot: 2, logo: "https://upload.wikimedia.org/wikipedia/en/f/f4/Atletico_Madrid_2017_logo.svg" },
  ...
  { id: "juventus", name: "Juventus", shortName: "JUV", country: "ITA", city: "Turin", pot: 2, logo: "https://upload.wikimedia.org/wikipedia/commons/a/a8/Juventus_FC_-_pictogram.svg" },
  ...
  // Bombo 3
  { id: "feyenoord", name: "Feyenoord", shortName: "FEY", country: "NED", city: "Rotterdam", pot: 3, logo: "https://upload.wikimedia.org/wikipedia/en/e/e3/Feyenoord_logo.svg" },
  { id: "sporting", name: "Sporting CP", shortName: "SCP", country: "POR", city: "Lisbon", pot: 3, logo: "https://upload.wikimedia.org/wikipedia/en/e/e1/Sporting_Clube_de_Portugal_%28Logo%29.svg" },
  ...
  { id: "dinamo", name: "Dinamo Zagreb", shortName: "DIN", country: "CRO", city: "Zagreb", pot: 3, logo: "https://upload.wikimedia.org/wikipedia/en/3/3a/GNK_Dinamo_Zagreb_logo.svg" },
  ...
  { id: "crvena", name: "Crvena Zvezda", shortName: "CZV", country: "SRB", city: "Belgrade", pot: 3, logo: "https://upload.wikimedia.org/wikipedia/en/e/e9/Crvena_zvezda_logo.svg" },
  ...
  // Bombo 4
  { id: "slovan", name: "Slovan Bratislava", shortName: "SLO", country: "SVK", city: "Bratislava", pot: 4, logo: "https://upload.wikimedia.org/wikipedia/en/e/e4/%C5%A0K_Slovan_Bratislava_logo.svg" },
  { id: "monaco", name: "AS Monaco", shortName: "MON", country: "FRA", city: "Monaco", pot: 4, logo: "https://upload.wikimedia.org/wikipedia/en/c/cf/AS_Monaco_FC.svg" },
  { id: "sparta", name: "Sparta Praha", shortName: "SPA", country: "CZE", city: "Prague", pot: 4, logo: "https://upload.wikimedia.org/wikipedia/en/6/6a/AC_Sparta_Prague_logo.svg" },
  { id: "aston-villa", name: "Aston Villa", shortName: "AVL", country: "ENG", city: "Birmingham", pot: 4, logo: "https://upload.wikimedia.org/wikipedia/en/9/9a/Aston_Villa_FC_crest_%282016%29.svg" },
  ...
  { id: "girona", name: "Girona", shortName: "GIR", country: "ESP", city: "Girona", pot: 4, logo: "https://upload.wikimedia.org/wikipedia/en/e/e6/Girona_FC_new_logo.svg" },
  ...
  { id: "brest", name: "Stade Brestois", shortName: "BRE", country: "FRA", city: "Brest", pot: 4, logo: "https://upload.wikimedia.org/wikipedia/en/6/61/Stade_Brestois_29_logo.svg" },
];
